...
<img src="docs/screenshots/game_timer_sidebar.png" alt="wordfinder game timer sidebar" width=33% height=50%> <img src="docs/screenshots/times_up_alert.png" alt="times up alert" width=33% height=50%> <img src="docs/screenshots/new_high_score_alert.png" alt="new high score alert" width=33% height=50%>
